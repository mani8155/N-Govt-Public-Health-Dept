...
def user_login(request):
    ...
    return render(request, 'new_login/auth-login-cover.html')


def get_roles_tbl_filter(request, role_id):
    url = "https://api.apistudio.app/getapi/asa0501_01_01"
...
def get_roles_tbl_all(request):
    url = "https://api.apistudio.app/getapi/asa0501_01_01/all"
    payload = {}
    headers = {}
